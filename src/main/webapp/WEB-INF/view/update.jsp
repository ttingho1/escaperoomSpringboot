...
<form class="w960 sigunup_form" action="/update" method="post">
    <div class="mb-3 id">
        <label class="form-label">이메일</label>
        <div class="id_check">
            <input type="text" class="form-control" id="userid" name="email" value="${user.email}" disabled>
        </div>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="password" class="form-control" name="pwconfirm" value="${user.pwconfirm}">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <div class="phone">
            ...
            <input type="text" class="form-control" name="phone3" value="${user.phone3}">
        </div>
    </div>
    <button type="submit" class="btn btn-primary signup_button" id="btn-save">수정하기</button>
</form>
<!--Footer-->
